...
from .views import index, post_create_form_view, board_list_view, board_topic_list_view, post_detail_view, post_update_view, post_delete_view, create_comment_view, delete_comment_view
...
urlpatterns=[
    ...
    path('delete_comment/<int:comment_id>/', delete_comment_view, name='delete-comment'),
